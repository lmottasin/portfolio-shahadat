...
const Hero: React.FC<HeroProps> = ({ name, major }) => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center px-6 overflow-hidden pt-32 pb-16 lg:pt-24 lg:pb-12">
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 relative z-10 items-center">
        <div className="lg:col-span-7 flex flex-col items-start order-2 lg:order-1">
          ...
          >
            <p className="text-indigo-400 font-black tracking-[0.3em] lg:tracking-[0.6em] text-[10px] lg:text-xs mb-6 lg:mb-8 flex items-center gap-3 lg:gap-4">
              <span className="w-8 lg:w-12 h-px bg-indigo-500/50"></span>
              The Visual Storyteller
            </p>
            <h1 className="text-5xl sm:text-7xl lg:text-[8rem] xl:text-[9.5rem] font-serif font-black italic text-white leading-[0.9] lg:leading-[0.8] mb-8 lg:mb-10 tracking-tighter">
              Shahadat <br />
            ...
            <div className="max-w-xl">
              ...
              <div className="flex flex-wrap gap-4 lg:gap-6">
                <a 
                  href="#projects" 
                  className="w-full sm:w-auto text-center px-8 lg:px-10 py-4 lg:py-5 bg-white text-black font-black text-[10px] lg:text-xs uppercase tracking-widest rounded-full hover:bg-indigo-500 hover:text-white transition-all shadow-2xl hover:scale-105 active:scale-95"
                >
                  Explore Archive
                </a>
                <a 
                  href="#about" 
                  className="w-full sm:w-auto text-center px-8 lg:px-10 py-4 lg:py-5 border border-white/20 text-white font-black text-[10px] lg:text-xs uppercase tracking-widest rounded-full hover:bg-white/10 transition-all"
                >
                  My Story
                </a>
              </div>
        ...
        <div className="lg:col-span-5 relative flex justify-center order-1 lg:order-2">
          <motion.div 
            ...
            className="relative w-full max-w-[260px] sm:max-w-md aspect-[4/5] group"
          >
            ...
            <motion.div 
              ...
              className="absolute -top-4 -right-4 lg:-top-10 lg:-right-8 glass p-4 lg:p-8 rounded-2xl lg:rounded-3xl border border-white/10 shadow-2xl z-20"
            >
              <div className="text-right">
                ...
                <div className="mt-2 lg:mt-4 flex justify-end gap-1">
                  {[1, 2, 3].map(i => <div key={i} className="w-1 lg:w-1.5 h-0.5 lg:h-1 bg-white/40 rounded-full"></div>)}
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <motion.div 
        ...
        className="absolute bottom-4 lg:bottom-12 flex flex-col items-center gap-3 lg:gap-4 cursor-pointer hidden sm:flex"
