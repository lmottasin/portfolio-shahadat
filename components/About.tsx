        ...
        <div className="lg:col-span-5 flex flex-col justify-start">
          ...
          >
            <div className="flex items-center gap-4 mb-6 lg:mb-8">
              ...
              <h2 className="text-indigo-400 font-black uppercase tracking-[0.3em] lg:tracking-[0.4em] text-[10px] lg:text-xs">
                The Identity
              </h2>
            </div>
            
            <h3 className="text-5xl sm:text-6xl lg:text-8xl font-serif font-black italic text-white leading-[0.85] tracking-tighter mb-8 lg:mb-10">
              Media as a <br /> 
              <span className="text-indigo-500 not-italic">Catalyst.</span>
            </h3>
            
            <div className="space-y-6 max-w-lg">
              <p className="text-xl lg:text-2xl text-slate-100 font-medium leading-relaxed">
          ...
          <div className="mt-12 lg:mt-16 p-8 lg:p-10 glass rounded-2xl lg:rounded-[2rem] border border-white/10 relative overflow-hidden group">
            ...
            <p className="text-white text-lg lg:text-xl font-serif italic mb-3 lg:mb-4 relative z-10 leading-relaxed">"The architect of social change through evidence."</p>
        ...
        <div className="lg:col-span-7 flex flex-col gap-12 lg:gap-16">
          <section>
            <div className="p-8 lg:p-12 border border-white/10 rounded-[2rem] lg:rounded-[3rem] bg-gradient-to-br from-white/[0.03] to-transparent shadow-2xl relative overflow-hidden group">
              ...
              <span className="text-[9px] lg:text-[10px] text-slate-500 uppercase tracking-[0.2em] lg:tracking-[0.3em] block mb-4">Academic Background</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-6 lg:gap-y-8">
              {details.objectives.slice(0, 6).map((obj, i) => (
                ...
                >
                  ...
                  <p className="text-slate-300 text-sm lg:text-[15px] leading-relaxed group-hover:text-white transition-colors duration-300 pt-1">
                    {obj}
                  </p>
                </motion.div>
              ))}
